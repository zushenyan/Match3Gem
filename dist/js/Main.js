...
},{"core-js/shim":186,"regenerator/runtime":188}],2:[function(require,module,exports){
...
var Board = (function () {
	...
	_createClass(Board, [{
		...
		value: function swap(sourceX, sourceY, targetX, targetY) {
			return _BoardUtils2["default"].swap(this._board, sourceX, sourceY, targetX, targetY, this._compareFunction);
		}
	}, {
...
var BoardPatterns = [{ pattern: horizontalPattern1, anchorX: 0, anchorY: 0 }, { pattern: horizontalPattern1, anchorX: 0, anchorY: 1 }, { pattern: horizontalPattern2, anchorX: 0, anchorY: 0 }, { pattern: horizontalPattern2, anchorX: 0, anchorY: 1 }, { pattern: horizontalPattern3, anchorX: 0, anchorY: 0 }, { pattern: horizontalPattern3, anchorX: 0, anchorY: 1 }, { pattern: verticalPattern1, anchorX: 0, anchorY: 0 }, { pattern: verticalPattern1, anchorX: 1, anchorY: 0 }, { pattern: verticalPattern2, anchorX: 0, anchorY: 0 }, { pattern: verticalPattern2, anchorX: 1, anchorY: 0 }, { pattern: verticalPattern3, anchorX: 0, anchorY: 0 }, { pattern: verticalPattern3, anchorX: 1, anchorY: 0 }];
 ...
 */
	testSwap: function testSwap(board, sourceX, sourceY, targetX, targetY, compareFunction) {
 ...
 */
	swap: function swap(board, sourceX, sourceY, targetX, targetY, compareFunction) {
		var result = BoardUtils.testSwap(board, sourceX, sourceY, targetX, targetY, compareFunction);
		if (result) {
...
var GameManager = (function () {
	function GameManager(board) {
		...
		this._board = null;
		this._timer = _GameConstants2["default"].TIME_LIMIT;
	...
	_createClass(GameManager, [{
		key: "start",
		value: function start(board) {
			this.newBoard(board);
		}
	}, {
		key: "newBoard",
		value: function newBoard(board) {
			return this._board = board ? board : _BoardUtils2["default"].createBoard(_GameConstants2["default"].SIZE_WIDTH, _GameConstants2["default"].SIZE_HEIGHT, _GameConstants2["default"].TYPES);
		}
	}, {
		key: "hint",
		value: function hint() {
			return _BoardUtils2["default"].findPossibleMatch(this._board);
		}
	}, {
		key: "swap",
		value: regeneratorRuntime.mark(function swap(sourceX, sourceY, targetX, targetY) {
			var matchedList;
			return regeneratorRuntime.wrap(function swap$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						matchedList = _BoardUtils2["default"].swap(this._board, sourceX, sourceY, targetX, targetY);
					...
					case 5:
						context$2$0.next = 7;
						return _BoardUtils2["default"].clearMatched(this._board, matchedList, _GameConstants2["default"].EMPTY);

					case 7:
						context$2$0.next = 9;
						return _BoardUtils2["default"].triggerGravity(this._board, _GameConstants2["default"].EMPTY);

					case 9:
						context$2$0.next = 11;
						return _BoardUtils2["default"].fillEmpty(this._board, _GameConstants2["default"].TYPES, _GameConstants2["default"].EMPTY);

					case 11:
						matchedList = _BoardUtils2["default"].findMatchedAll(this._board);
					...
					case 13:
						if (!(_BoardUtils2["default"].findPossibleMatch(this._board).length < 3)) {
							context$2$0.next = 15;
							break;
						}

						return context$2$0.abrupt("return", this.newBoard());
